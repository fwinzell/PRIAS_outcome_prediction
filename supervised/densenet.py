...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        self.features.add_module("relufinal", nn.ReLU(inplace=True))
...
def densenet169(**kwargs: Any) -> DenseNet:
    model = DenseNet(32, (6, 12, 32, 32), 64, **kwargs)
    return model
...
if __name__ == "__main__":
    ...
    model = densenet201(use_classifier=True)
