...
import numpy as np
from resnet import resnet50, count_parameters
import os
...
class Cumulative_Probability_Layer(nn.Module):
    ...
    """
    def __init__(self, num_features, max_followup, make_probs_indep=False, use_base_pred=False):
...
class PRIAS_Model(nn.Module):
    ...
    def __init__(self,
        ...
        # Cumulative probability layer for predicting future risk
        self.cpl = Cumulative_Probability_Layer(1024, 3)
